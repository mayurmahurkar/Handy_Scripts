...
ap.add_argument("--folder_path", required = True, help = "folder path of images which is to be augmented")
...
# image_file="/home/omkar/Desktop/Omkar/AI/important_scripts/data_augmentation/Data_Original_Mahindra_Circlip/sushrut_2_373.JPEG"

for image_path in os.listdir(args['folder_path']):
	Folder_name= os.path.splitext(os.path.splitext(os.path.basename(image_path))[0])[0]+"augmented_image"
	Extension=".JPEG"

	if not os.path.exists(Folder_name):
	    os.makedirs(Folder_name)

	image=cv2.imread(args['folder_path'] + '/' + image_path)
	# resize_image(image,416,416)
	...
	# crop_image(image,100,300,0,350)#(y1,y2,x1,x2)(bottom,top,left,right)
	# crop_image(image,100,400,100,350)#(y1,y2,x1,x2)(bottom,top,left,right)
	# crop_image(image,0,400,0,450)#(y1,y2,x1,x2)(bottom,top,left,right)
	# crop_image(image,0,200,100,250)#(y1,y2,x1,x2)(bottom,top,left,right)
	# crop_image(image,100,200,100,250)#(y1,y2,x1,x2)(bottom,top,left,right)

	# crop_image(image,100,250,150,300)
	# crop_image(image,100,400,300,500)
	# crop_image(image,450,400,450,500)
	# crop_image(image,150,250,100,200)
	# crop_image(image,200,350,300,450)
	# crop_image(image,150,250,200,300)
	# crop_image(image,150,400,300,450)
	# crop_image(image,100,500,300,450)
	# crop_image(image,100,250,150,350)
	# crop_image(image,100,450,300,500)
	# crop_image(image,100,250,200,300)
	# crop_image(image,100,250,150,400)
	# crop_image(image,100,250,150,450)
	# crop_image(image,100,250,200,450)
	...
	contrast_image(image,20)
	contrast_image(image,30)
	contrast_image(image,40)
